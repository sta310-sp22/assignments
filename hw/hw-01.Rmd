...
5. The dataset `kingCountyHouses.csv` contains data on over 20,000 houses sold in King County, Washington (@kingcounty).^[from Sec. 1.8.2, Ex 3]
    ...
    **d.** Fit Model 3, where `price` and `logsqft` are the response and explanatory variables, respectively. How does the predicted price change when sqft increases by 5%? *As a hint, this is the same as multiplying sqft by 1.05.*
