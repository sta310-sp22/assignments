...
- **Teamwork** (3 pts)
  - Did the team present a unified story? (3 pts)

- **Slides** (4 pts) 
  - Are the slides well organized, readable, not full of text, featuring figures with legible labels, legends, etc.?

- **Content**: The model replication and original analysis will be graded based on the following. (3 pts each part)
...
- **Overall objectives** (1 pt)
  - Did the team clearly articulate the overall research objectives of the original paper and how their analysis differs / builds up on the analysis from the article? 
...
You should have the following files and folders in the project repo. The repo and brief summary in the README should be updated by **Wednesday, February 09 at 11:59pm**.
