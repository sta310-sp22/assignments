...
Use the terms "multilevel model" or "longitudinal model" to help find articles with relevant models. See the [Tips on finding articles](#Tips_on_finding_articles) section for tips on searching databases and [Example articles](#Example_articles) section for articles.
...
Below are example articles you can use for the project. You are welcome to (but not required to) to use one of these articles. No more than 2 groups can use an article for their analysis.  
