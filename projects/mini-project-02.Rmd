...
Briefly summarize the article, the research objective and purpose, and primary audience. Also include a brief description of the data used for the analysis.
...
The objective of the final section of the written report is to assess the authors' argument and communication. 
